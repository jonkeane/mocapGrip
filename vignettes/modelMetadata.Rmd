...
{ "variableExplanations" : {
	...
	"dataPreProcessing" : ["data$stick <- factor(as.character(data$stick), levels = c('five', 'seven', 'nine', 'eleven'))",
												"contrasts(data$stick) <- contr.treatment(levels(data$stick), base = 2) # make seven the reference level",
...
* `processFunctionOptions` Options to be passed to the processing function. This should always include percentOcclusion, but may include others.   
...
This section has a list of commands to run before processing any of the dataSets. This is where you can change reference level, or make transformations on **all** of the data. The data is a large dataframe called `data`.
