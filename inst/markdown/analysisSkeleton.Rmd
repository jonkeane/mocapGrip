...
There are varying intercepts by subject, and the effects of all the predictors <>$includeInteractionInGroup<> are also allowed to vary <>$groupingVariable<> (these are the mixed effects). The full formula for this model is <>$formula<>
