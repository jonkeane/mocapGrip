...
test_that("replaceText works with formatGatherReplacements", {
  ...
  expect_equal(mocapGrip:::replaceText(list("$outcome"), formatGatherReplacements("action", dataModeled)),c("maximum grip aperture (in mm)"))
...
#
# mocapGrip:::writeMarkdown(dataModeled)
#
# test_that("", {
#
# })
